...
public:
    ...
    Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const cv::Mat &imLeftRGB, const double &timeStamp, ORBextractor* extractorLeft, ORBextractor* extractorRight, ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth);
    ...
    void ExtractORB(int flag, const cv::Mat &im, const cv::Mat &imRGB);
